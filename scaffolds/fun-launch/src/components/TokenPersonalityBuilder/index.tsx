...
export function TokenPersonalityBuilder({ tokenMint, onSave, initialData }: TokenPersonalityBuilderProps) {
  ...
  return (
    <div className="bg-mystic-steam-ash rounded-lg border border-mystic-steam-copper/20 p-6">
      <h2 className="text-2xl font-heading font-bold mb-6 text-mystic-steam-copper">
      ...
      {/* Tabs */}
      <div className="flex gap-2 mb-6 border-b border-mystic-steam-copper/20">
        <button
          onClick={() => setActiveTab('preset')}
          className={`px-4 py-2 font-body font-medium transition-colors ${
            activeTab === 'preset'
              ? 'text-mystic-steam-copper border-b-2 border-mystic-steam-copper'
              ...
              <button
                ...
                className={`p-4 rounded-lg border-2 transition-all ${
                  selectedPreset === presetName
                    ? 'border-mystic-steam-copper bg-mystic-steam-copper/10'
                    : 'border-mystic-steam-copper/20 hover:border-mystic-steam-copper/40'
                }`}
              >
                <div className="text-2xl mb-2">{PRESETS[presetName as keyof typeof PRESETS].branding.emojis[0]}</div>
                <div className="font-heading font-semibold text-mystic-steam-copper">{presetName}</div>
              </button>
            ))}
          </div>
        </div>
      ...
      <div className="mt-6">
        ...
        <textarea
          ...
          className="w-full h-32 p-3 bg-mystic-steam-charcoal border border-mystic-steam-copper/20 rounded-lg text-mystic-steam-parchment font-body focus:outline-none focus:ring-2 focus:ring-mystic-steam-copper"
      ...
      <div className="mt-6 space-y-4">
        <h3 className="text-lg font-heading font-semibold text-mystic-steam-copper">Style Sliders</h3>
        {(['chaos', 'friendliness', 'formality', 'aggression', 'humor'] as const).map((key) => (
          <div key={key}>
            <div className="flex justify-between mb-2">
              ...
              <span className="text-sm font-body text-mystic-steam-copper">{style[key]}</span>
            </div>
            <input
              type="range"
              min="0"
              ...
              className="w-full h-2 bg-mystic-steam-charcoal rounded-lg appearance-none cursor-pointer accent-mystic-steam-copper"
            />
          </div>
        ))}
      </div>
      ...
      {/* Branding */}
      <div className="mt-6">
        <h3 className="text-lg font-heading font-semibold mb-4 text-mystic-steam-copper">Branding</h3>
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full p-3 bg-mystic-steam-charcoal border border-mystic-steam-copper/20 rounded-lg text-mystic-steam-parchment font-body"
      ...
      <div className="mt-6 grid md:grid-cols-2 gap-4">
        <div>
          ...
          <textarea
            ...
            className="w-full h-24 p-3 bg-mystic-steam-charcoal border border-mystic-steam-copper/20 rounded-lg text-mystic-steam-parchment font-body"
            placeholder="Trading\nPrice action\nCommunity"
          />
        </div>
        <div>
