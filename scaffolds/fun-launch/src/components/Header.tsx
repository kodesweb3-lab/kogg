        ...
        {isMobileMenuOpen && (
          ...
          >
            <nav className="flex flex-col p-4 gap-1">
              ...
              <div className="flex items-center justify-center gap-4 pt-4 mt-2 border-t border-ritual-amber-500/10">
                <a
                  href="https://x.com/KogaionSol"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-4 py-2 text-gray-400 hover:text-ritual-amber-400 transition-colors"
                >
