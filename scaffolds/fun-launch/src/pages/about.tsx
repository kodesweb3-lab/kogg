...
export default function AboutPage() {
  return (
    <Page narrow>
      <div className="py-6 md:py-10 text-[var(--text-primary)]">
        <PageTitle
          title="About Kogaion"
          description="High-tech launchpad on Solana. Launch, discover, earn. More fees to devs."
        />
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="mt-3 text-[var(--text-muted)]">
              Full flow: <Link href="/create-pool" className="text-[var(--accent)] hover:underline">Launch a Token</Link> → pool creation → list → swap.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 text-[var(--text-muted)]">
              As a creator you can claim your fees from the <Link href="/dashboard" className="text-[var(--accent)] hover:underline">Dashboard</Link>.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-3 space-y-1 text-[var(--text-muted)]">
              <li>
                <Link href="/for-agents" className="text-[var(--accent)] hover:underline">For Agents</Link> — API hub and links.
              </li>
              <li>
                <a href="/skill.md" target="_blank" rel="noopener noreferrer" className="text-[var(--accent)] hover:underline">skill.md</a> — Full API reference for agents.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <dl className="space-y-4 text-[var(--text-muted)]">
              ...
              <div>
                ...
                <dd className="mt-1">Yes. See <Link href="/for-agents" className="text-[var(--accent)] hover:underline">For Agents</Link> and skill.md for endpoints and limits.</dd>
              </div>
            </dl>
          </section>

          <p className="text-sm text-[var(--text-muted)]">
            Questions? Reach out via <a href="https://t.me/kogaionpack" target="_blank" rel="noopener noreferrer" className="text-[var(--accent)] hover:underline">Telegram</a> or <a href="https://x.com/KogaionSol" target="_blank" rel="noopener noreferrer" className="text-[var(--accent)] hover:underline">X (Twitter)</a>.
          </p>
        </div>
      </div>
    </Page>
