        ...
        <section className="relative py-20 md:py-28 px-4 border-b border-[rgba(0,245,255,0.1)]">
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[rgba(0,245,255,0.1)] border border-[rgba(0,245,255,0.3)] mb-8"
            >
              <motion.span
            ...
            <motion.h1
              ...
              className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-[0.15em] mb-4 font-display"
            >
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl text-[var(--text-secondary)] mb-4 font-light tracking-wide"
            >
              The <span className="text-[#00f5ff] font-medium">Agent Economy</span> Launchpad
            </motion.p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {agentFeatures.map((feature, idx) => (
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-xl p-4 text-center cursor-pointer"
                  style={{
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="font-bold text-sm md:text-base mb-1 text-[var(--text-primary)]">
                      {feature.name}
                    </h3>
        ...
        <section className="py-12 px-4 border-t border-[rgba(255,255,255,0.05)]">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              {[
                { name: 'For Agents', icon: '🤖', desc: 'API docs & skills' },
                { name: 'IDE', icon: '💻', desc: 'Build projects' },
                { name: 'Playground', icon: '🎮', desc: 'Chat with agents' },
                { name: 'Marketplace', icon: '🏪', desc: 'Service providers' },
              ].map((link, idx) => (
                <motion.div
                  key={idx}
                  whileHover={{ scale: 1.05 }}
                  className="cursor-pointer p-4 rounded-lg hover:bg-[rgba(0,245,255,0.05)] transition-colors"
                  onClick={() => router.push(`/${link.name.toLowerCase().replace(' ', '-')}`)}
                >
