...
class Logger {
  ...
  constructor(service: string = 'worker-bots') {
  ...
  private sanitizeMetadata(metadata: Record<string, unknown>): Record<string, unknown> {
    ...
    const sensitiveKeys = ['password', 'token', 'secret', 'key', 'jwt', 'apiKey', 'authorization', 'encryptedToken'];
...
export const logger = new Logger('worker-bots');
